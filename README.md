...
Согласно заданию для варианта 12, приложение позволяет создавть и работать с заметками, которые могут ииеть теги и вложения**. Возможен поиск заметок по тексту. 
...
7. POST: /notes/search - поиск заметки по её тексту и названию (пример зароса показан в примере 2);
...
2. Для выполнения запроса требуется отправить json-файл с текстом, по которому выполняется поиск нужной заметки или заметок. Скриншот с примером находится ниже.
